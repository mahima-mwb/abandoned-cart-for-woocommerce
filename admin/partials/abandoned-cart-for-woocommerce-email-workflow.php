						...
						<div class="mwb-form-group__control mwb-pl-4">
							<div class="mdc-form-field">
								<div class="mdc-checkbox">
									<input name="checkbox[]" id="<?php echo 'enable_email-workflow_' . $ew_id; ?>" type="checkbox" class="mdc-checkbox__native-control m-checkbox-class" <?php echo isset( $enable_value ) ? esc_html( 'checked' ) : ''; ?>			/>
